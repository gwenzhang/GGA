...
dataset_type = 'KittiDataset_GGA_match'
...
db_sampler = dict(
    data_root=data_root,
    info_path=data_root + 'kitti_dbinfos_train_GGA.pkl',
    rate=1.0,
    prepare=dict(
...
train_pipeline = [
    ...
    dict(type='Collect3D_GGA', keys=['points', 'gt_bboxes_3d', 'gt_labels_3d', 
                                     # GGA inputs
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file=data_root + 'kitti_infos_trainval_GGA.pkl',
            # priori=data_root + 'mean_point_infos_with_height.pkl',
            split='training',
...
log_level = 'INFO'
work_dir = './work_dirs/kitti_GGA'
load_from = None
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 1)

### for the default_runtime ###
