...
from .mvx_two_stage_gga import MVXTwoStageDetector_GGA


@DETECTORS.register_module()
class GGA(MVXTwoStageDetector_GGA):
    ...
    def forward_pts_train(self,
        ...
        loss_inputs = [gt_bboxes_3d, gt_labels_3d, outs, GGA_boxes_img, GGA_lidar2img, GGA_init_pseudo_labels, GGA_bdry_masks, GGA_in_box_points, img_metas]
