...
class MVXTwoStageDetector_GGA(Base3DDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(MVXTwoStageDetector_GGA, self).__init__(init_cfg=init_cfg)
    ...
    def forward_train(self,
                      ...
                      GGA_boxes_img=None, 
                      GGA_lidar2img=None, 
                      GGA_init_pseudo_labels=None,
                      GGA_bdry_masks=None, 
                      GGA_in_box_points=None,
                      gt_labels=None,
                      gt_bboxes=None,
                      img=None,
                      proposals=None,
        ...
        losses = dict()
        if pts_feats:
            losses_pts = self.forward_pts_train(pts_feats, gt_bboxes_3d, gt_labels_3d, 
                                                GGA_boxes_img, GGA_lidar2img, GGA_init_pseudo_labels, GGA_bdry_masks, GGA_in_box_points,
